...
nj_tracts <- st_read("~/Box/NJSOARH/Data/Spatial_Data/Reference_Layers/Census2010Tr2012/Govt_TIGER2012_tract2010.shp")
...
nj_tracts_PSH <- left_join(nj_tracts, PictureSubsidizedHousing, by = c("TRACTID" = "geoid")) # put them together
...
nj_map <- tm_shape(simplify_shape(nj_tracts_PSH), unit = "mi") +
   ...
   # tm_compass(north = 0, type = 'arrow', show.labels =0, position = c('right','bottom')) + 
    ...
    legend.title.size = 3,
    main.title = "HCV Units by NJ Census Tract",
    main.title.size = 1.5,
    frame = FALSE)
nj_map
