...
nj_munis_housingChange <- transform(nj_munis_housingChange, popden_2020 = pop20 / SQ_MILES)
...
tm <- tm_shape(nj_munis_housingChange) +
...
tmap_save(tm, filename = "nj_muni_housingChange_2020.png")
