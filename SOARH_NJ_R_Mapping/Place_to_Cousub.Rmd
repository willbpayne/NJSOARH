---
title: "PLACE to Cousub Conversion"
author: "Will P"
date: "11/29/2021"
output: html_document
---

```{r setup, import PLACE data, and pivot wider}
...
```{r separate CDPs/cousubs/remainders}
...
```{r handle remainders and edge cases, merge all usable rows}
...
write.csv(place_PSH_Final_with_Counties, 'place_PSH_Final_with_Counties.csv', na = "")
