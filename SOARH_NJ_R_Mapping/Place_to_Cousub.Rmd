...
# section of manual updates based on townships with ambiguous names
...
manual_tract_aggregation_list <- c(3402970320,3402903050,3401304695,3401306260,3400129280,3402129310,3401133120,3402133180,3401139450,3402139510,3401547250,3402347280,3402554270,3402954300,3401577180,3402777240,3404177300)
...
# SOMETHING'S WRONG WITH 3400377135 and 3400577150 TOO!
# AND PRINCETON
...
CDP_to_Cousub_Mapping <- filter(CDP_to_Cousub_Mapping, MUNI_MUN_LABEL != 'Sparta Township') # remove one of the ambiguous CDPs since all housing units are in Byram Township
...
place_PSH_Final <- place_PSH_Unmerged_Final %>%
  group_by(CENSUS2010) %>%
  summarise(count = n(), units = sum(Pg1_total_units))
