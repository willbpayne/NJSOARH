...
rm(CDPs_to_Remove)
# need to pull out our crosswalk table here and remove CDPs that have ambiguous munis
...
# joining time!
Cousubs_2020_Proj_no_geo <- st_drop_geometry(Cousubs_2020_Proj) # drop geometry
Cousubs_2020_Proj_no_geo$NAMELSAD <- str_to_upper(Cousubs_2020_Proj_no_geo$NAMELSAD) # update format of join field
place_PSH_good_Cousubs_with_Munis <- left_join(place_PSH_good_Cousubs, Cousubs_2020_Proj_no_geo, by = "NAMELSAD") # put them together
