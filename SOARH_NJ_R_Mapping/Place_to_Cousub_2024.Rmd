...
if (cousub_year == '2023' & state_code == '34') {
  place_PSH_good_Cousubs$NAMELSAD[place_PSH_good_Cousubs$NAMELSAD == "PRINCETON BOROUGH"] <- "PRINCETON" # manually set Princeton Borough (Mercer County) to Princeton to match Census
}
...
rm(Ambiguous_Muni_GEOID_List,Ambiguous_Muni_Name_List,place_PSH_good_Cousubs_with_Munis_Duplicates,Ambiguous_CDP_Muni_GEOID_List)
