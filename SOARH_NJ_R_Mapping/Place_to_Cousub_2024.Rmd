...
Census_Cousubs_2020 <- st_read(paste("Census_Geographies/2020_cousub/tl_2020_", state_code,"_cousub/tl_2020_", state_code, "_cousub.shp", sep = "")) 
Census_Cousubs_2020 <- Census_Cousubs_2020 %>% filter(!grepl('not defined', NAME)) # extract non-remainders (CDPs) with working geoids
...
rm(Census_Cousubs_2020)
# need to deal with PINE VALLEY!!!
...
rm(CDPs_with_Munis_Duplicates_Total, CDP_Cousub_intersects)
...
rm(CDPs_with_Munis_Duplicates_Total_List)
