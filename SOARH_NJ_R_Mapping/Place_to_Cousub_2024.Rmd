...
CDPs_with_Munis_Duplicates_Total_List <- CDP_Cousub_intersects[CDPs_with_Munis_Duplicates_Total,c("NAMELSAD", "NAMELSAD.1","coverage")]

CDPs_with_Munis_Duplicates_Total_Export <- st_drop_geometry(CDPs_with_Munis_Duplicates_Total_List) # remove geometry
...
CDP_Correspondence_Table_clean <- filter(CDP_Correspondence_Table, !(GEOID_Cousub == 3403709160 & NAMELSAD_CDP == 'Lake Mohawk CDP')) # remove one of the ambiguous CDPs since all housing units are in Sparta Township
CDP_Correspondence_Table_clean <- filter(CDP_Correspondence_Table_clean, !(GEOID_Cousub == 3400553070 & NAMELSAD_CDP == "McGuire AFB CDP")) # remove one of the ambiguous CDPs since all housing units are in North Hanover Township
...
write.csv(place_PSH_CDPs_with_Munis, 'place_PSH_CDPs_with_Munis_2023_no_geo.csv', na = "")
...
# come up with a list of cousubs that need to be manually aggregated for 2023 (NOT UPDATED)
manual_tract_aggregation_list <- c(3402970320, # Stafford (Ocean)
                                   3402903050, # Barnegat (Ocean)
                                   3401304695, # Belleville (Essex)
                                   3401306260, # Bloomfield (Essex)
                                   3400129280,3402129310,3401133120,3402133180,3401139450,3402139510,3401547250,3402347280,3402554270,3402954300,3401577180,3402777240,3404177300,3401974420,3400569990,3403970020,3401924870,3401524840,3403974480,3400577150,3400377135)
